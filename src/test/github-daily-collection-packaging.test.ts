...
describe("daily GitHub collection image bundle", () => {
  it("builds both Node 22 bundles without source maps", async () => {
    ...
    expect(builder).toContain('entryPoints: ["scripts/github-connection-reconcile.ts"]');
    expect(builder).toContain("dist/github-connection-reconcile.mjs");
