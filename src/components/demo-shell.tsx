...
export function DemoShell({ children }: { children: React.ReactNode }) {
  ...
  return <div className="app-shell">
    ...
    <div className="app-main">
      ...
      <section className="demo-banner" aria-label="Demo notice"><Icon name="alert"/><span><b>You&apos;re viewing a demo.</b> Explore freely — this is sample data for Northstar Labs.</span><Link href="/sign-up">Create your workspace</Link></section>
