...
export async function GET(request: Request): Promise<NextResponse> {
  ...
  if (!workspaceAccess(context.membership.role).section("connections").canManageOperation("manage-github-app")) {
  ...
  let connection: Awaited<ReturnType<typeof getGitHubConnectionConfig>> | null = null;
  try {
  ...
  if (installationId === null) {
    return redirectTo(new URL(`/apps/${connection.appSlug}/installations/new`, "https://github.com"));
  }
