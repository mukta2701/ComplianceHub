...
export default async function AssetDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <>
    ...
    <PageIntro eyebrow={`ASSET ${asset.reference}`} title={asset.description} body={asset.owner_location || "Information asset"} action={canManage && <Link className="button secondary" href={`/app/assets/${id}/edit`}>Edit</Link>} />
