...
describe("connected control review choices", () => {
  ...
  it("lets ordinary members read finalised statements without creation actions", async () => {
    ...
    expect(screen.getByRole("link", { name: /Assess current practices/ })).toHaveAttribute("href", "/app/assessment");
    expect(screen.getAllByRole("link", { name: "Source assessment" }).length).toBeGreaterThan(0);
  });
