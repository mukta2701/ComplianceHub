...
export default function DemoTasksPage() {
  return <>
    ...
    <div className="stats-grid"><Stat label="OPEN TASKS" value={3} detail="across all sources" /><Stat label="OVERDUE" value={2} detail="past their due date" tone="red" /><Stat label="RECURRING" value={2} detail="regenerate on completion" tone="green" /></div>
