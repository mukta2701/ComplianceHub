...
describe("Azure staging deployment contract", () => {
  ...
  it("gates mutation on the hosted schema and registered canonical GitHub origin", () => {
    ...
    expect(workflow).toContain("20260818110000");
    ...
    expect(deployment).toMatch(/supabase db push --dry-run[\s\S]*20260817010000[\s\S]*20260817020000[\s\S]*20260817030000[\s\S]*20260817192458[\s\S]*20260818030000[\s\S]*20260818040000[\s\S]*20260818050000[\s\S]*20260818060000[\s\S]*20260818070000[\s\S]*20260818100000[\s\S]*20260818110000/);
