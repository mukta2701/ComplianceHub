...
> **Superseded for M1 closeout — 25 September 2026:** For remaining Milestone 1 work, follow [`2026-09-25-github-m1-dev-closeout.md`](2026-09-25-github-m1-dev-closeout.md) instead. Per the Owner's approved AWS-dev decision (see the [revised M1 design](../specs/2026-09-14-github-organisation-repository-integration-design.md)), the separate staging contract and staging deployment substeps in Phases 8–9 are superseded for M1 — AWS dev is the pilot acceptance environment and no separate staging stack is required. Live GitHub pilot acceptance remains required and is moved to AWS dev under the new closeout plan. The shared-image/finite-runner work (Phase 8 Task 8) is not claimed obsolete. The original phase details below remain as historical detail.
