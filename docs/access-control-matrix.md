...
|---|---:|---:|---|
| `alert_channels` | R/W | — | Delivery configuration and secrets are operator-only. |
...
| `integration_connections` | R/W | — | GitHub/Jira connection configuration and tokens are operator-only. |
