...
select is(
  ...
  'ai_suggestions,ai_workspace_settings,alert_channels,alert_deliveries,assessment_responses,assessment_sessions,asset_categories,asset_risks,assets,audit_checklist_items,audit_events,audit_findings,auditor_access_log,auditor_access_tokens,audits,automation_assignments,automation_proposal_sources,automation_proposals,automation_rules,automation_signals,baseline_progress,baseline_snapshots,collection_runs,connector_connections,control_crosswalks,daily_digest_deliveries,daily_digest_delivery_attempts,evidence,evidence_links,evidence_sources,github_collection_runs,github_compliance_result_alert_events,github_compliance_result_alert_states,github_connection_incidents,github_connection_reconciliation_runs,github_entry_materialisation_receipts,github_evidence_provenance,github_finding_provenance,github_finding_transitions,github_installations,github_mapping_approvals,github_mapping_entry_decisions,github_mapping_pack_selection_history,github_mapping_pack_selections,github_materialisation_jobs,github_oauth_states,github_observations,github_official_compliance_results,github_repositories,github_webhook_deliveries,integration_authorization_states,integration_connection_targets,integration_connections,integration_sync_claim_connections,integration_sync_claim_organisations,integration_sync_jobs,integration_webhook_deliveries,integration_webhook_delivery_rollups,invitations,jira_webhook_cleanup_jobs,kpi_measurements,kpis,leadership_report_snapshots,memberships,monitor_sources,monitoring_findings,notifications,organisation_scope_profiles,pending_jira_authorizations,policies,policy_acceptances,policy_feedback_comments,policy_feedback_threads,risk_categories,risk_matrix_config,risk_treatment_plans,risks,soa_items,soa_registers,soa_snapshots,source_objects,task_contributions,task_tickets,tasks,trust_center_settings',
