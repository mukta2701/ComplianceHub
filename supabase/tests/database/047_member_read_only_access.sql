...
select is(
  ...
  'ai_suggestions,ai_workspace_settings,alert_channels,assessment_responses,assessment_sessions,asset_categories,asset_risks,assets,audit_checklist_items,audit_events,audit_findings,auditor_access_log,auditor_access_tokens,audits,automation_assignments,automation_proposal_sources,automation_proposals,automation_rules,automation_signals,collection_runs,connector_connections,control_crosswalks,daily_digest_deliveries,daily_digest_delivery_attempts,evidence,evidence_links,evidence_sources,github_collection_runs,github_evidence_provenance,github_finding_provenance,github_finding_transitions,github_installations,github_mapping_approvals,github_materialisation_jobs,github_oauth_states,github_observations,github_official_compliance_results,github_repositories,github_webhook_deliveries,integration_connections,invitations,kpi_measurements,kpis,leadership_report_snapshots,memberships,monitor_sources,monitoring_findings,notifications,organisation_scope_profiles,policies,policy_acceptances,policy_feedback_comments,policy_feedback_threads,risk_categories,risk_matrix_config,risk_treatment_plans,risks,soa_items,soa_registers,soa_snapshots,source_objects,task_tickets,tasks,trust_center_settings',
